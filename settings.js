...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~VphWwTYS#tjnRZePEcaxlZGxjNmvgkobKVNMJ2JsF2ygO84eeuss",
// add your Session Id 

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "✦MAKIMA",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "+91 7012285101",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "✦JOHN WICK🪀✦",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "> *© POWERED BY JOHN WICK*",
// add bot owner name    
